...
namespace UserModule_BIAMP_TESIRA_PRESET_CONTROL_V3_0
{
    public class UserModuleClass_BIAMP_TESIRA_PRESET_CONTROL_V3_0 : SplusObject
    {
        ...
        BiampTesiraLib3.PresetComponent COMPONENT;
        public void ONINITIALIZECHANGE ( object __sender__ /*BiampTesiraLib3.PresetComponent SENDER */, BiampTesiraLib3.UInt16EventArgs ARGS ) 
            { 
    ...
    {
        COMPONENT  = new BiampTesiraLib3.PresetComponent();
        
        
    }
    
    public UserModuleClass_BIAMP_TESIRA_PRESET_CONTROL_V3_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
